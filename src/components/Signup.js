      ...
      <Grid container spacing={1}>
        <Grid item xs={8} className={classes.gridOne}>
          ...
          <h5 className={classes.headerThree}>Already have an account? 
            <Link to='/form_error' className={`${classes.firstLink}${animationClasses()}`}>
              <a> Sign in</a>
            </Link>
          </h5>
          <Paper className={classes.paperOne}>
            <FormControl className={classes.formControl} noValidate autoComplete="off">
            <TextField id="outlined-basic" disabled className={classes.formField} label="Your name" variant="outlined" />
            <TextField
              id="outlined-basic"
              label="Email address"
              variant="outlined"
